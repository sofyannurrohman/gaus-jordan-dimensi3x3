...
class GausPage extends StatefulWidget {
  const GausPage({Key? key}) : super(key: key);

  @override
  State<GausPage> createState() => _GausPageState();
}

class _GausPageState extends State<GausPage> {
                ...
                Row(
                  ...
                  children: [
                    MaterialButton(
                      ...
                      color: kPrimaryColor,
                      onPressed: () {
                        if (!prov.checkAllNotEmpty()) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text('Harus diisi semua !')),
                          );
                          return;
                        }
                        if (!prov.checkAllNumeric()) {
                          ScaffoldMessenger.of(context).showSnackBar(
